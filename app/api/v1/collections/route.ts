...
export async function GET(request: NextRequest) {
  try {
    ...
    const backendUrl = `${BACKEND_API_URL}/collections?${searchParams.toString()}`;
    
    console.log('Proxying collections request to backend:', backendUrl);
    ...
    console.log('Backend collections response received:', { 
    ...
    return NextResponse.json(
      {
        ...
        error: {
          code: 'PROXY_ERROR',
          message: 'Failed to fetch collections from backend',
