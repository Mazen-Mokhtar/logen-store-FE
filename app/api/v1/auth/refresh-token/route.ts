...
export async function POST(request: NextRequest) {
  try {
    ...
    const backendUrl = `${BACKEND_API_URL}/v1/auth/refresh-token`;
    
    console.log('Proxying refresh token request to backend:', backendUrl);
    ...
    console.log('Backend refresh token response received:', { 
